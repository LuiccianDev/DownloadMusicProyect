...
// Iconos SVG en línea para un mejor control de estilos
...
const ThemeToggle = () => {
  ...
  const renderIcon = () => {
    switch (theme) {
      ...
      case 'dark':
        return <MoonIcon className="w-6 h-6 text-slate-400" />;
      case 'system':
      default:
        return <SystemIcon className="w-6 h-6 text-gray-500 dark:text-gray-400" />;
    }
  };
