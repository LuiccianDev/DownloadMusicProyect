            ...
            <div className="mx-10 sm:mx text-white flex flex-col ">
                ...
                <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                    ...
                    <div className="w-44 pt-6 md:pt-0 ">
                        <button className="cursor-pointer">
                            <a href="/Contact" className="transform transition-transform duration-300 hover:scale-110 bg-gradient-to-r from-purple-600 to-pink-600 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
                                Contact US
                            </a>
                        </button>
                ...
                <div className="flex flex-col ">
                    <div className="flex mt-24 mb-12 flex-row justify-between">
                        ...
                        <a href="/Contact" className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">
                            Contact
                        </a>
                        <div className="flex flex-row space-x-8 items-center justify-between">
                            <a className="cursor-pointer transform transition-transform duration-300 hover:scale-110" href="#">
                                <svg width="18" height="18" viewBox="0 0 6 12" fill="none">
                                    <path
                            ...
                            <a className="cursor-pointer transform transition-transform duration-300 hover:scale-110" href="#">
                                <svg width="18" height="18" viewBox="0 0 12 13" fill="none">
                                    <path
                            ...
                            <a className="cursor-pointer transform transition-transform duration-300 hover:scale-110" href="#">
                                <svg width="18" height="18" viewBox="0 0 13 9" fill="none">
                                    <path
                            ...
                            <a className="cursor-pointer transform transition-transform duration-300 hover:scale-110" href="#">
                                <svg width="18" height="18" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#fff">
