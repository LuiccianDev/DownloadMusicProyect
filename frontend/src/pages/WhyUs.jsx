...
export default function WhyUs() {
  return (
    <div className="min-h-fit bg-gray-100 dark:bg-gray-950 text-gray-800 dark:text-white flex items-center justify-center py-25">
      <div className="max-w-5xl w-full text-center section px-5 space-y-10">
        ...
        <p className="mt-4 text-sm sm:text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-300 " >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8">
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300 text-sm sm:text-lg md:text-xl">Enjoy crystal-clear sound with our top-notch audio technology.</p>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300 text-sm sm:text-lg md:text-xl">Lightning-fast downloads with full security for your data.</p>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300 text-sm sm:text-lg md:text-xl">Simple and intuitive interface for effortless navigation.</p>
          </div>
        </div>

        <div className="mt-8">
          <Link to="/download" className="inline-block px-6 py-3 bg-gradient-to-tl from-purple-600 to-pink-600 hover:bg-pink-700 text-white font-medium rounded-lg transition">
            Get Started Now
          </Link>
        </div>
      </div>
