...
export default function About() {
  return (
    <div className="min-h-fit flex items-center justify-center bg-gray-950 text-white pt-50">
      <div className="max-w-4xl text-center p-6">
        <h1 className="text-bold text-transparent text-7xl bg-clip-text bg-gradient-to-tl from-purple-600 to-pink-600 pb-4">About Us</h1>
