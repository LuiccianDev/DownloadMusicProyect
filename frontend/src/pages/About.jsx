...
export default function About() {
  return (
    <div className="min-h-fit flex items-center justify-center bg-gray-100 dark:bg-gray-950 text-gray-800 dark:text-white pt-50 text-pretty ">
      <div className="max-w-4xl text-center p-10 text-balace">
        ...
        <p className="mt-4 text-sm sm:text-lg md:text-xl text-gray-600 dark:text-gray-300">
          Welcome to <span className="text-pink-500 dark:text-pink-400 font-semibold">LazDev Music</span>, 
        ...
        <p className="mt-4 text-sm sm:text-lg md:text-xl text-gray-600 dark:text-gray-300">
          At <span className="text-pink-500 dark:text-pink-400 font-semibold">LazDev Music</span>, we believe in the power of music to 
