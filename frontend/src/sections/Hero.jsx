...
const Home = () => {
    ...
    const [rating, setRating] = useState(3); // State to manage the number of yellow stars
                ...
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center py-30">
                        ...
                        <div className="flex justify-center items-center gap-x-4 text-gray-400 text-sm">
                            <div className="flex">
                                {Array(5).fill(0).map((_, idx) => (
                                    <svg
                                        ...
                                        fill={idx < rating ? "yellow" : "currentColor"}
                                        viewBox="0 0 20 20"
                            ...
                            <p>
                                <span className="text-gray-100">{rating}.0</span> by over 200 users
                            </p>
                        </div>
                    </div>
                </div>
